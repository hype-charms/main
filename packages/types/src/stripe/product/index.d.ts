...
export declare class PriceReference {
    id?: string;
...
export declare class StripeItemReference<T = PackMetadata | ProductMetadata> {
    id?: string;
    unit_amount?: number | null;
    images?: string[];
    default_price?: string;
...
export declare enum ProductPacks {
    KAWS = "kaws-pack",
    NARUTO = "naruto-pack",
...
export declare enum CategoryImages {
...
export declare enum ProductFilters {
    FEATURED = "Featured",
